...
public class ServiceConfigs {
    ...
    private final int DEFAULT_PORT = 9903;
    ...
    private final long DEFAULT_REQUESTINTERVAL = 500;
    private final int DEFAULT_MAXRAPIDREQUEST = 5;
    ...
    public ServiceConfigs(ConfigsModel cm) throws NullPointerException {
        if (cm == null) {
            ...
            if (outputFile == null) {
                ...
                System.err.println("Logging output file not found. Using default.");
            } else {
            ...
            if (dbUsername == null) {
                System.err.println("No database username found!.");
                dbConfigValid = false;
            } else {
            ...
            if (dbPassword == null) {
                System.err.println("No database password found.");
                dbConfigValid = false;
            } else {
            ...
            if (dbHostname == null) {
                System.err.println("No database hostname found.");
                dbConfigValid = false;
            } else {
            ...
            if (dbPort == 0) {
                System.err.println("No database port found.");
                dbConfigValid = false;
            ...
            if (requestInterval < 0) {
                System.err.println("Invalid requestInterval found in configuration file. Using default.");
                requestInterval = DEFAULT_REQUESTINTERVAL;
            } else {
                System.err.println("RequestInterval: " + requestInterval);
            }

            maxRapidRequest = Integer.parseInt(cm.getBotcatcherConfig().get("maxRapidRequest"));
            if ( maxRapidRequest < 0) {
                System.err.println("Invalid requestInterval found in configuration file. Using default.");
                maxRapidRequest = DEFAULT_MAXRAPIDREQUEST;
            }else {
                System.err.println("MaxRapidRequest: " + maxRapidRequest);
    ...
    public void currentConfigs() {
        ...
        ServiceLogger.LOGGER.config("Interval Request: " + requestInterval);
        ServiceLogger.LOGGER.config("Max Rapid Request " + maxRapidRequest);
    }
