package edu.uci.ics.hieutt1.service.idm;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.hieutt1.service.idm.configs.ConfigsModel;
import edu.uci.ics.hieutt1.service.idm.configs.ServiceConfigs;
...
public class IDMService {
    ...
    public static final String RESOURCE_PATH = "edu.uci.ics.hieutt1.service.idm.resources";
    ...
    public static long getRequestInterval() {
        return serviceConfigs.getRequestInterval();
    }
    public static int getMaxRapidRequest() {
        return serviceConfigs.getMaxRapidRequest();
    }
}
