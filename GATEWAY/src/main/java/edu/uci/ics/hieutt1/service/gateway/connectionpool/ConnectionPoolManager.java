package edu.uci.ics.hieutt1.service.gateway.connectionpool;
...
public class ConnectionPoolManager
{
    ...
    public synchronized Connection requestCon()
    {
        ...
        Connection con = null;
        try {
            con = hikariConPool.getConnection();
        }catch (SQLException e) {
            ServiceLogger.LOGGER.warning("Query failed: Unable to connect to database.");
            e.printStackTrace();
        }
        return con;
    }
