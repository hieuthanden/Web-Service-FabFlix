...
@rem ##########################################################################
@rem
@rem  edu.uci.ics.hieutt1.service.movies startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and EDU_UCI_ICS_HIEUTT1_SERVICE_MOVIES_OPTS to pass JVM options to this script.
...
:fail
rem Set variable EDU_UCI_ICS_HIEUTT1_SERVICE_MOVIES_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%EDU_UCI_ICS_HIEUTT1_SERVICE_MOVIES_EXIT_CONSOLE%" exit 1
exit /b 1
