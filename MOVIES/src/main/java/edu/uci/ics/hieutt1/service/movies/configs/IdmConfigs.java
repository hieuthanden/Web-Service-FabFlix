package edu.uci.ics.hieutt1.service.movies.configs;
...
public class IdmConfigs {
    ...
    private final String DEFAULT_SESSION = "/session";
    ...
    public void currentConfigs() {
        ...
        ServiceLogger.LOGGER.config("IDM Session Path: " + sessionPath);
    }
